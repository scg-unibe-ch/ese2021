# ESE2021 Scaffolding Git and GitHub

## Brief introduction

Git is a version control system (VCS) which allows to track changes to our project
over time. It enables us to record project changes and go back to a specific version 
of the tracked files, at any given point in time. This system can be used by many 
people to efficiently work together and collaborate on team projects, where each 
developer can have their own version of the project, distributed on their computer. 
Later on, these individual versions of the project can be merged and adapted into the
main version of the project.

## Install Git

Git is primarily used via the command-line interface, which we can access with our system 
terminals.

However, we first need to make sure that we have Git installed on our computers.

### IOS or Windows users

- Install in your operating system Git (any kind of Git tool should work the same, I use 
Git Bash) under the Link [https://git-scm.com/downloads]

- Check if the installation worked properly by opening your terminal (cmd) and typing 

git --version

If everything went well, it should return the Git version that is installed on your 
computer.
...
- Type in your system command prompt as follows: $ 
